...
export const groupInterviews = (interviews: Interview[]): InterviewStatusGrouped => {
  if (!interviews) return { succeeded: [], failed: [], completed: [], upcoming: [] };

  return interviews.reduce((acc: InterviewStatusGrouped, interview: Interview) => {
